...
namespace ChosenConcept.APFramework.UI.Layout
{
    ...
    public partial class LayoutAlignment : BoxContainer
    {
        ...
        {
            // Sync config to godot-specific properties
            Size = new(_referenceResolution.X, _referenceResolution.Y);
            Vertical = _layoutSetup.windowDirection == WindowDirection.Vertical;

            switch (_layoutSetup.offsetSource)
            {
                case OffsetSource.CenterOfScreen:
                ...
                case OffsetSource.Fullscreen:
                    ...
                    break;
                default:
                    throw new ArgumentOutOfRangeException(nameof(_layoutSetup.offsetSource), _layoutSetup.offsetSource, null);
            }
